...
// This will be the main screen for chat, and contain chat bubbles as well as a chatbox
// where you can type
// and send messages. Create the activity as well as a corresponding XML file, activity_chat_start.xml.
...
public class ChatStartActivity extends ChatActivity {
    ...
    private final String mChannelUrl = "open_channel_adidas";
    ...
    public class ChatAdapter extends Adapter {
        ...
        public ChatAdapter(OpenChannel openChannel) {
        }
        ...
        private class ReceivedMessageHolder extends RecyclerView.ViewHolder {
            ...
            void bind(UserMessage message) {
                ...
                Utils.displayRoundImageFromUrl(ChatStartActivity.this,
